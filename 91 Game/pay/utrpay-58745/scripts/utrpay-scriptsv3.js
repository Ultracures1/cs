...
function setUpUI(){
    if(paymentUPI!="" && rechargeAmount!=""){
        let qrTxt = `data=upi%3A%2F%2Fpay%3Fpa%3D${paymentUPI}%26pn%3Dabgroup%26am%3D${rechargeAmount}%26cu%3DINR&size=200x200`;
        qrCodeLink = `https://api.qrserver.com/v1/create-qr-code/?`+qrTxt;
